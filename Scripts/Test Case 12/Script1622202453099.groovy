...
WebUI.setText(findTestObject('Object Repository/Mattermost_login/input_loginId'), 'faketester@gmail.com')

WebUI.setText(findTestObject('Object Repository/Mattermost_login/input_password'), 'Hcmus2017!')
