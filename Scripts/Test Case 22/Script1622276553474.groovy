...
TestObject pinButtonObject = new TestObject()

pinButtonObject.setSelectorMethod(SelectorMethod.BASIC)

pinButtonObject.addProperty('tag', ConditionType.EQUALS, 'button', true)

pinButtonObject.addProperty('text', ConditionType.EQUALS, 'Pin to Channel', true)

WebUI.click(pinButtonObject)
