...
WebUI.setText(findTestObject('Object Repository/Mattermost_login/input_loginId'), 'tester@gmail.com')

WebUI.setText(findTestObject('Object Repository/Mattermost_login/input_password'), 'wrongpassword!')
