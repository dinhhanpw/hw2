...
WebUI.setText(findTestObject('Object Repository/Mattermost_signup/input_password'), 'test')

WebUI.click(findTestObject('Object Repository/Mattermost_signup/button_Create Account'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Mattermost_signup/notification_password'), 10)
