...
WebUI.setText(findTestObject('Object Repository/Mattermost_signup/input_email'), 'tester')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Mattermost_signup/input_email'), 10)
