...
viewButtonObject.addProperty('text', ConditionType.EQUALS, 'Edit Channel Purpose', true)

WebUI.click(viewButtonObject)

WebUI.setText(findTestObject('Object Repository/Mattermost_channel/textarea_edit purpose'), 'A channel to test features of mattermost')
