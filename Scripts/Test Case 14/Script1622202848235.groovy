...
WebUI.setText(findTestObject('Object Repository/Mattermost_login/input_loginId'), "' or 1=1--")

WebUI.setText(findTestObject('Object Repository/Mattermost_login/input_password'), "' or 1=1--")
