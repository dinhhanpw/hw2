...
WebUI.setText(findTestObject('Object Repository/Mattermost_signup/input_email'), 'oldtester@gmail.com')

WebUI.setText(findTestObject('Object Repository/Mattermost_signup/input_username'), 'super_tester')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Mattermost_signup/label_existed email'), 10)
